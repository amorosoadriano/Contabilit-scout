...
const TransactionList: React.FC<TransactionListProps> = ({ transactions, groups, onDelete, onEdit }) => {
  ...
  if (transactions.length === 0) {
    return (
      <div className="text-center py-16 px-6 bg-white rounded-lg shadow-md">
        ...
        <h3 className="mt-2 text-lg font-medium text-gray-900">Nessuna Transazione</h3>
        <p className="mt-1 text-sm text-gray-500">Inizia aggiungendo una nuova entrata o uscita.</p>
      </div>
    );
  }
              ...
              return (
                <tr key={t.id} className="hover:bg-slate-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="text-sm text-slate-500">{t.category} - {t.paymentMethod}</div>
                  </td>
